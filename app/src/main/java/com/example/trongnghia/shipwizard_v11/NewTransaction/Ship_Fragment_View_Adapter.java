 ...
 */
public class Ship_Fragment_View_Adapter extends ArrayAdapter<Ship_Fragment_View_List_Item> {


    private final Context context;
    private final ArrayList<Ship_Fragment_View_List_Item> itemsArrayList;

    public Ship_Fragment_View_Adapter(Context context, ArrayList<Ship_Fragment_View_List_Item> itemsArrayList)
    {
        super(context, R.layout.fragment_ship_view_list_item, itemsArrayList);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.fragment_ship_view_list_item, parent, false);
